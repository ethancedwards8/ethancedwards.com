...
Essentially, `git rebase` is a way to manipulate and edit git histories. A common use
for it is reordering a series of commits. In Nixpkgs this is commonly used for new
