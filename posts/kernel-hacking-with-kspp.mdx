...
found Greg Kroah-Hartman's [video at FOSDEM](https://www.youtube.com/watch?v=LLBrBBImJt4) on how to write and submit a kernel patch (a fancy word for a piece of code).
...
For better or worse, not many projects can say their development process has remained untouched for 15 years.
...
kind and patient enough to take [my code](https://web.git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=f6a1a425cbb74f4836f2e21e0110330c65e33ad2 "My SELinux Contribution").
...
to meaningfully contribute needed and valuable security fixes to the Linux Kernel.
Google employee [Kees Cook](https://github.com/kees "Kees Cook's GitHub") has dedicated large amounts of time to making the kernel
...
is neat considering he is responsible for my involvement in the KSPP. Thanks, Gustavo!
...
the Kernel Self Protection Project is about. Most of the changes within the project
...
Essentially, instead of using `kzalloc(nr * sizeof(*int), ...)` we would use
